all: filtered_seqs/count_seqs_output.txt

filtered_seqs/count_seqs_output.txt: Shell/separate_seqs.sh blast_results/summary.txt
	bash Shell/separate_seqs.sh `sort -rk5 blast_results/summary.txt | sed -n 2p | cut -f1`
...
blast_results/1e-1_summary.txt: Shell/blast_cni_sym.sh ref/cni_blastdb.nal ref/sym_blastdb.nal
	bash Shell/blast_cni_sym.sh \
	data/weedy_coral_01Feb2017_zhEnG/weedy_coral_01Feb2017_zhEnG.fasta \
	1e-1
blast_results/1e-2_summary.txt: Shell/blast_cni_sym.sh ref/cni_blastdb.nal ref/sym_blastdb.nal
	bash Shell/blast_cni_sym.sh \
	data/weedy_coral_01Feb2017_zhEnG/weedy_coral_01Feb2017_zhEnG.fasta \
	1e-2
blast_results/1e-3_summary.txt: Shell/blast_cni_sym.sh ref/cni_blastdb.nal ref/sym_blastdb.nal
	bash Shell/blast_cni_sym.sh \
	data/weedy_coral_01Feb2017_zhEnG/weedy_coral_01Feb2017_zhEnG.fasta \
	1e-3
blast_results/1e-4_summary.txt: Shell/blast_cni_sym.sh ref/cni_blastdb.nal ref/sym_blastdb.nal
	bash Shell/blast_cni_sym.sh \
	data/weedy_coral_01Feb2017_zhEnG/weedy_coral_01Feb2017_zhEnG.fasta \
	1e-4
blast_results/1e-5_summary.txt: Shell/blast_cni_sym.sh ref/cni_blastdb.nal ref/sym_blastdb.nal
	bash Shell/blast_cni_sym.sh \
	data/weedy_coral_01Feb2017_zhEnG/weedy_coral_01Feb2017_zhEnG.fasta \
	1e-5
blast_results/1e-10_summary.txt: Shell/blast_cni_sym.sh ref/cni_blastdb.nal ref/sym_blastdb.nal
	bash Shell/blast_cni_sym.sh \
	data/weedy_coral_01Feb2017_zhEnG/weedy_coral_01Feb2017_zhEnG.fasta \
	1e-10
